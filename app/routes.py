...
def follow(username):
    ...
    db.session.commit()
    flash('You are following user:{}'.format(username))
    return redirect(url_for('user',username=username))
...
def unfollow(username):
    ...
    db.session.commit()
    flash('You are unfollowing user:{}'.format(username))
    return redirect(url_for('user',username=username))
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Check you email for the instructions to reset password')
        return redirect(url_for('login'))
